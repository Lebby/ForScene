 ...
 * 
 */
public class GameLoopManager implements IGameLoopManager {

  /** Singlethon instance. */
  private static IGameLoopManager       instance         = null;
  ...
  private GameLoopManager() {
    ...
    GameLoopManager.root = PlayN.graphics().rootLayer();
    PlayN.log().debug("AGLM called");
  }

  protected GameLoopManager(AbstractGame game) {
    this();
    this.game = game;
  }
  ...
  public static IGameLoopManager getInstance(AbstractGame game) {
    if (GameLoopManager.instance == null) {
      GameLoopManager.instance = new GameLoopManager(game);
    }
   ...
   * (non-Javadoc)
   * 
   * @see forscene.system.managers.IGameLoopManager#postBuild()
   */
   ...
   * (non-Javadoc)
   * 
   * @see forscene.system.managers.IGameLoopManager#build()
   */
  public void build() {
    game.build();
  }
   ...
   * (non-Javadoc)
   * 
   * @see forscene.system.managers.IGameLoopManager#preBuild()
   */
