...
/**
 * The listener interface for receiving abstractKeyboard events.
 * The class that is interested in processing a abstractKeyboard
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addAbstractKeyboardListener<code> method. When
...
public class AbstractKeyboardListener extends Adapter implements IListener {	
	 ...
	 * Instantiates a new abstract keyboard listener.
	 *
	 * @param eventKeyDown the event key down
	 * @param eventKeyUp the event key up
	 */
